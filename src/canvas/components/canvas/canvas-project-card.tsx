        ...
        <article className="group flex min-h-44 cursor-pointer flex-col justify-between rounded-2xl bg-[#f0f0f2] p-5 transition hover:bg-[#e8e8ec] dark:bg-white/5 dark:hover:bg-white/10" onClick={() => !editing && open()}>
            <div className="flex items-start gap-3">
                <input
                    ...
                    className="mt-1 size-4 accent-zinc-950 dark:accent-zinc-100"
            ...
            <div className="mt-8 flex items-end justify-between gap-3">
                <p className="text-xs text-zinc-500">{t("canvas.project.updated", { date: new Date(project.updatedAt).toLocaleString(i18n.resolvedLanguage, { month: "2-digit", day: "2-digit", hour: "2-digit", minute: "2-digit" }) })}</p>

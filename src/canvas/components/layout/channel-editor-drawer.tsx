        ...
        >
            ...
            <div className="mt-6 mb-3 flex flex-wrap items-center justify-between gap-2">
                <div>
                    ...
                    <div className="mt-0.5 text-xs text-zinc-500">{t("config.channelEditor.modelDescription", { count: draft.models.length })}</div>
                </div>
            ...
            <div className="space-y-2 rounded-lg border border-zinc-200 p-2 dark:border-zinc-800">
                {draft.models.length ? (
                    draft.models.map((model) => (
                        <div key={model.name} className="flex flex-wrap items-center gap-3 rounded-md px-2 py-1.5 hover:bg-zinc-50 dark:hover:bg-zinc-900/40">
                    ...
                    <div className="px-2 py-8 text-center text-sm text-zinc-500">{t("config.channelEditor.empty")}</div>
                )}
            </div>

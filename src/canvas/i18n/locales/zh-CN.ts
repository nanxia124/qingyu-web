export default {
    ...
    mainHome: {
        ...
        latest: "最新",
        empty: "没有找到匹配的作品",
        inputPlaceholder: "描述你想创作的内容，AI 帮你生成…",
    },
    imageTools: {
        historyTitle: "我的生成",
        ...
        taskQueryFailed: "查询失败，请稍后重试",
        historyQueryFailed: "查询历史失败，请稍后重试",
        pollTimeout: "生成时间较长，结果稍后会出现在历史记录中",
        tabInpaint: "局部重绘",
        tabExpand: "扩图",
        tabCutout: "抠图",
        tabSuperRes: "超分辨率",
        tabRepair: "修复",
        favoriteSyncFailed: "收藏同步失败，请稍后重试",
        insufficient: "积分不足，本次需要 {{need}} 积分，当前剩余 {{balance}} 积分",
        resultFilePrefix: "生成结果",
        extraRequirement: "补充要求（可选）",
        extraRequirementPlaceholder: "在这里添加额外要求…",
        uploadToTranslate: "点击上传需要翻译的图片",
        translateFormats: "PNG / JPG / WebP，单张 ≤ 10MB，可多选",
        startAfterUpload: "上传图片后开始翻译",
        editTextPlaceholder: "输入要改成的文案…",
        translatedResult: "翻译结果",
        waitingTranslate: "等待翻译",
        translatingStatus: "翻译中…",
        clickStartAfterUpload: "上传后点击开始翻译",
        continueAdd: "继续添加",
        startTranslate: "开始翻译",
        inDevelopment: "正在开发",
        translatedSuffix: "（翻译后）",
        generate: "生图",
        blend: "融图",
        translate: "图片翻译",
        prompt: "提示词",
        ...
        startGen: "开始生成",
        estimated: "预估",
        inputPromptFirst: "输入提示词后生成",
        noResults: "还没有生成结果",
        resultsHint: "输入提示词后点击生成",
        allTime: "全部时间",
        today: "今天",
        last7: "近7天",
        last30: "近30天",
        ...
        addCommon: "添加常用提示词",
        titlePlaceholder: "标题（如：日系动漫风）",
        promptContent: "提示词内容",
        undo: "撤销",
        confirmDeleteTitle: "删除图片",
        confirmDelete: "确定要删除这张图片吗？已保存到云端的会移入回收站，30 天内可恢复。",
        describeEffect: "描述你想要的效果…",
        targetLangs: { zh: "中文", en: "英文", ja: "日文", ko: "韩文", fr: "法文", de: "德文" },
        pendingTrans: "待翻译",
        uploadImageShort: "上传图片",
        pasteImageShortcut: "粘贴图片 (Ctrl+V)",
        tipFormat: "格式",
        tipAddCommon: "添加常用提示词",
        tipReuse: "复用参数",
        tipCopyPrompt: "复制提示词",
        tipCopyImage: "复制图片",
        tipQuote: "引用",
        ...
        toasts: {
          ...
          promptTooLong: "提示词不能超过 200 字",
          cleared: "已清空提示词",
          imageTooLarge: "图片不能超过 10MB",
          maxRefs: "最多上传 4 张参考图",
          openedFolder: "已打开存储文件夹",
          switchedDir: "已切换到",
          cancelledDir: "已取消选择文件夹",
          copiedImage: "已复制图片",
          quoted: "已引用",
          shared: "已发起团队分享",
          downloaded: "已下载",
          openedInFolder: "已打开所在文件夹",
          filled: "已填入提示词",
          saved: "已保存",
          saveFirstShare: "请先保存到云端后再分享",
          shareFailed: "分享失败，请稍后重试",
          noTeam: "你还没有加入任何团队",
          noTeamWorkspace: "团队工作空间未就绪",
          sharedToTeam: "已分享到团队：{{name}}",
        },
        blendFormats: "PNG / JPG / WEBP / BMP",
        blendStrength: "融合强度",
        blendResult: "结果预览",
        blendWait: "等待图片",
        blendWaitHint: "上传后可查看原图、结果和滑动对比",
        blendProcessing: "AI 正在处理…",
        transTarget: "目标语言",
        transStart: "开始翻译",
        transEmpty: "上传图片后，翻译结果将显示在这里",
        cancel: "取消",
        save: "保存",
    },
    auth: {
        brandPlaceholder: "在这里放置品牌介绍图",
        subtitleLogin: "登录或注册以继续",
        ...
        opFailed: "操作失败",
        opFailedRetry: "操作失败，请稍后重试",
        oauthNotAvail: "第三方登录暂未开通，请使用邮箱登录",
    },
    chat: {
        selectModel: "选择模型",
        greeting: "有什么可以帮你？",
        subtitle: "选择模型，输入问题开始对话",
        justNow: "刚刚",
        copy: "复制",
        copied: "已复制",
        thinking: "正在思考…",
    ...
    pages: {
        assets: { all: "全部", image: "图片", video: "视频", audio: "音频", doc: "文档", file: "其他文件", search: "搜索素材…", upload: "上传素材", empty: "没有找到匹配的素材", uploaded: "已上传 {{count}} 个文件", uploadFailed: "{{count}} 个文件上传失败：{{names}}", preview: "素材预览", view: "查看", download: "下载", loading: "正在读取素材…", unsupportedPreview: "此文件格式暂不支持在线预览，请下载后查看", recycleBin: "回收站", backToAssets: "返回素材", moveToRecycleBin: "移到回收站", moveToRecycleBinConfirm: "确定把「{{name}}」移到回收站吗？文件不会被删除。", restore: "恢复", restoreConfirm: "确定恢复「{{name}}」吗？", movedToRecycleBin: "素材已移到回收站", restored: "素材已恢复" },
        ...
        subscription: { loginFirst: "请先登录", activated: "已开通，额度已到账", activateFailed: "开通失败", title: "订阅套餐", subtitle: "选择适合你的套餐，解锁全部能力", currentQuota: "当前额度", free: "免费版", validUntil: "会员有效期至", perMonth: "/月", currentPlan: "当前套餐", activating: "开通中...", currentFree: "当前免费", activateNow: "立即开通", paymentNote: "支付方式：当前为演示支付，微信支付 / 支付宝将在后续接入" },
        account: {
            profile: { updated: "资料已更新", updateFailed: "更新失败，请稍后重试", loginFirst: "请先登录", title: "个人资料", uploadAvatar: "上传头像", avatarHint: "支持 JPG、PNG，最大 2MB", nickname: "昵称", nicknamePh: "请输入昵称", email: "邮箱", emailHint: "邮箱用于登录，暂不支持修改", saving: "保存中...", save: "保存", security: "账号安全", changePassword: "修改密码", passwordHint: "定期更换密码以保障账号安全", goChange: "去修改" },
            billing: { paid: "已支付", pending: "待支付", failed: "支付失败", title: "账单与发票", currentSub: "当前订阅", upgrade: "升级计划", history: "历史发票", loading: "加载中...", noInvoices: "暂无发票记录", invNo: "发票号", amount: "金额", status: "状态", date: "日期", action: "操作", download: "下载" },
            security: { curPwdRequired: "请输入当前密码", newPwdMin: "新密码至少 8 位", mismatch: "两次输入的密码不一致", changed: "密码修改成功", changeFailed: "修改失败，请稍后重试", title: "安全设置", curPwd: "当前密码", curPwdPh: "请输入当前密码", newPwd: "新密码", newPwdPh: "至少 8 位", confirmPwd: "确认新密码", confirmPwdPh: "再次输入新密码", changing: "修改中...", change: "修改密码", pwdNeedLetterAndDigit: "密码必须同时包含字母和数字", pwMatch: "两次输入一致", saveSuccess: "渠道已保存", createSuccess: "渠道已创建" },
        },
        team: {
            teams: { created: "团队创建成功", createFailed: "创建失败，请稍后重试", title: "我的团队", createBtn: "创建团队", createTitle: "创建新团队", namePh: "团队名称", cancel: "取消", creating: "创建中...", create: "创建", owner: "所有者", admin: "管理员", empty: "还没有团队，点击右上角创建第一个团队" },
            members: { inviteSent: "邀请已发送", inviteFailed: "邀请失败，请稍后重试", owner: "所有者", admin: "管理员", member: "成员", selectFirst: "请先选择一个团队", title: "团队成员", inviteBtn: "邀请成员", inviteTitle: "邀请成员", emailPh: "输入对方邮箱", inviteHint: "对方将收到邀请邮件，接受后加入团队", cancel: "取消", sending: "发送中...", sendInvite: "发送邀请", loading: "加载中...", role: "角色", joinedAt: "加入时间", action: "操作" },
        },
        authPage: { fillBoth: "请填写邮箱和密码", emailInvalid: "邮箱格式不正确", pwdMin: "密码至少 8 位", fillNick: "请填写昵称", opFailed: "操作失败，请重试", login: "登录", register: "注册", nickname: "昵称", email: "邮箱", password: "密码（至少8位）", loading: "加载中...", noAccount: "还没有账号？", hasAccount: "已有账号？" },
        resetPwd: { invalid: "无效的重置链接，请重新申请", invalidOnly: "无效的重置链接", pwdMin: "密码至少 8 位", mismatch: "两次输入的密码不一致", success: "密码重置成功，正在跳转登录...", failed: "重置失败", failedRetry: "重置失败，请稍后重试", title: "重置密码", subtitle: "请设置新密码", newPwdPh: "新密码（至少8位）", confirmPh: "确认新密码", submitting: "提交中...", confirm: "确认重置", backHome: "返回首页", pwdNeedLetterAndDigit: "密码必须同时包含字母和数字", pwMatch: "两次输入一致", saveSuccess: "渠道已保存", createSuccess: "渠道已创建" },
        ...
        admin: {
            ...
            signupGift: { tab: "注册赠分", title: "新用户注册赠分", description: "修改后只影响保存后注册的新用户；已经到账的积分不会改变。填写 0 可暂停赠分。", amount: "赠分数", unit: "积分", save: "保存", saving: "保存中…", saved: "注册赠分设置已保存", invalid: "请输入大于或等于 0 的有效数字", saveFailed: "保存注册赠分设置失败" },
            billing: { adjustPrompt: "调整用户 {email} 的积分（当前 {balance}），输入变动数（正/负）：", adjusted: "已调整", orderDone: "订单已标记完成，权益已发放", generated: "已生成 {count} 个兑换码", tabs: { stats: "数据概览", users: "用户", orders: "订单", codes: "兑换码", plans: "套餐" }, title: "计费管理", overview: { userCount: "总用户", activeMember: "活跃会员", revenue: "总收入", todayRevenue: "今日收入", orderCount: "订单数", unusedCodes: "在途兑换码", unpaidOrders: "未支付订单", totalBalance: "平台总积分" }, userCols: { email: "邮箱", balance: "余额", member: "会员", expire: "到期", spent: "累计消费", action: "操作" }, adjustPoints: "调整积分", orderCols: { no: "订单号", user: "用户", plan: "套餐", amount: "金额", status: "状态", time: "时间", action: "操作" }, paid: "已支付", pending: "待支付", markPaid: "标记已付", gen: { count: "数量", kind: "类型", quota: "充值额度", membership: "会员套餐", denom: "面额(积分)", days: "有效期(天,0永久)", generate: "生成兑换码", result: "本次生成（可复制导出）：" }, codeCols: { code: "兑换码", denom: "面额", status: "状态", usedBy: "使用者", created: "生成时间" }, used: "已用", unused: "未用", plansNote: "套餐价格与额度配置请直接编辑 api-data/billing_plans.json，或后续接入可视化编辑。当前包含 free / pro / team 三档。" },
            dashboard: { title: "API 配置管理", changePw: "修改密码", logout: "退出登录", pwSuccess: "密码修改成功", oldPw: "旧密码", newPw: "新密码（至少 8 位）", confirmPw: "确认新密码", confirm: "确认修改", cancel: "取消", addBtn: "+ 添加 API 配置", editTitle: "编辑配置", newTitle: "新增配置", name: "名称", namePh: "比如：OpenAI 主 Key", provider: "提供商", apiUrl: "API 地址", apiKey: "API Key", apiKeyEdit: "（留空则不修改）", concurrency: "单 key 最大并发（留空用全局默认", selectedModels: "模型已选 {{count}} 个", selectModels: "选择模型", collapseAll: "折叠全部", expandAll: "展开全部", deselectAll: "取消全选", selectAll: "全选", removeAll: "取消添加全部", addAll: "添加全部", remove: "移除", add: "添加", noModelInCat: "该分类下没有模型", doneSelected: "完成（已选 {{count}} 个）", pullModels: "拉取模型", pulling: "拉取中...", save: "保存", loading: "加载中...", emptyHint: "还没有配置，点上面「添加 API 配置」开始", active: "启用中", inactive: "已停用", concurrencyLabel: "并发", success: "成功", fail: "失败", cooling: "熔断中", todayCalls: "今日调用", calls: "调用", successRate: "成功率", failRate: "失败率", connRate: "连接率", avgConnRate: "日均连接率", avgLatency: "平均延迟", weekCalls: "近7天调用", edit: "编辑", testing: "测试中...", testConn: "测试连接", normal: "正常", enable: "启用", disable: "停用", del: "删除", expandAll2: "展开全部", collapseAll2: "折叠全部", noData: "暂无数据", d7: "近7天", d30: "近30天", all: "全部", image: "图片", video: "视频", text: "文本", audio: "音频", other: "其他", fillRequired: "请填写完整信息：名称、API 地址、API Key 为必填项", saveFailed: "保存失败：", unknownErr: "未知错误", apiUrlFirst: "请先填写 API 地址", apiKeyFirst: "请先填写 API Key", saveFirstToPull: "请先保存渠道，再拉取模型", pullFailed: "拉取失败：", confirmDelete: "确定删除？", configNotExist: "配置不存在", pwMismatch: "两次新密码不一致", pwMin: "新密码至少 8 位", pwOldRequired: "请输入旧密码", pwNeedLetterAndDigit: "密码必须同时包含字母和数字", nameRequired: "请输入名称", apiUrlRequired: "请输入 API 地址", apiKeyRequired: "请输入 API Key", pwMatch: "两次输入一致", rangeAll: "全部", rangeD1: "近1天", rangeD3: "近3天", rangeD7: "近7天", rangeD30: "近1个月", rangeD90: "近3个月", rangeD365: "近1年", rangeCustom: "自定义", inFlight: "进行中", released: "已释放", unknown: "结果未知", detail: "明细", noUsageInRange: "所选时间没有调用记录。" },
        },
        wallet: { title: "我的钱包", currentBalance: "当前余额", currentMember: "当前会员", team: "团队版", free: "免费版", until: "至", totalSpent: "累计消费", tabCodes: "兑换码", tabOrders: "订单", tabTxns: "余额流水", tabInvite: "邀请好友", redeemTitle: "输入兑换码", redeem: "兑换", redeemHint: "兑换码可联系管理员获取，兑换后额度立即到账", noOrders: "暂无订单", hOrderId: "订单号", hPlan: "套餐", hAmount: "金额", hStatus: "状态", hTime: "时间", paid: "已支付", pending: "待支付", noTxns: "暂无流水", hType: "类型", hChange: "变动", hBalance: "余额", hNote: "说明", inviteTitle: "邀请好友", inviteDesc: "好友通过你的链接注册并充值，你可获得积分奖励", copyLink: "复制链接", invited: "已邀请", redeemSuccess: "兑换成功，当前余额", typeRegister: "注册赠送", typeRedeem: "兑换码充值", typeMembership: "会员到账", typeConsume: "消费扣费", typeRefund: "退款", typeInvite: "邀请奖励", typeAdmin: "后台调整", typeRecharge: "在线充值" },
    },
    nav: {
        home: "首页",
        chat: "聊天",
    ...
    settingsPanels: {
        ...
        model: { select: "选择模型", notFetched: "暂未获取到模型", refresh: "刷新模型列表", assign: "暂无{{capability}}模型", noMatch: "暂无匹配的{{capability}}模型", addFirst: "暂无可用模型", capabilities: { image: "生图", video: "视频", text: "文本", audio: "音频" } },
    },
    ...
    assets: {
        ...
        details: "资产详情",
        deleteTitle: "移到回收站",
        deleteConfirm: "确定把「{{name}}」移到回收站吗？你之后可以恢复。",
        movedToRecycleBin: "素材已移到回收站",
    ...
    errorState: {
        ...
        detail: "展开错误详情",
        codes: {
            "404": { title: "页面走丢了", desc: "你访问的地址不存在或已被移动" },
            "403": { title: "没有访问权限", desc: "这个内容属于别人，你可以联系作者开通权限" },
            "500": { title: "页面崩溃了", desc: "我们已经记录了这次错误，刷新试试" },
            "503": { title: "服务暂时不可用", desc: "检查一下网络，或稍后再试" },
            "401": { title: "登录已过期", desc: "请重新登录后继续" },
            "gone": { title: "内容不存在或已删除", desc: "可能是作者删除了，或链接已失效" },
        },
    },
    loading: {
        boot: "正在准备工作台…",
    ...
    videoWorkbench: {
        ...
        generating: "生成中…",
        startGen: "开始生成",
        inputPrompt: "输入提示词后生成",
        results: "生成结果",
        resultsEmpty: "生成的视频将显示在这里",
        auto: "自动",
        original: "原图",
        quality: "画质",
        frameMode: "帧模式",
    ...
    canvas: {
        ...
        toolbar: {
            ...
            themeMode: "主题模式", light: "浅色", dark: "深色", auto: "跟随系统", gridStyle: "网格样式", dots: "点", lines: "线", blank: "空白", imageInfo: "图片信息",
        },
        project: {
    ...
    agent: {
        ...
        state: { ready: "就绪", connectionRequired: "服务未连接", invalidUrl: "服务地址异常", offline: "离线", skillReadFailed: "读取 Skill 失败", skillParseFailed: "Skill 解析失败", requestFailed: "请求失败" },
        ...
        eventMore: { toolRunning: "{{action}}中…", openedRoute: "已打开{{route}}", canvasCount: "共 {{count}} 个画布", promptCount: "找到 {{count}} 条提示词", assetCount: "共 {{count}} 个资产", assetAdded: "已加入我的素材", generationStatus: "共 {{total}} 个任务，排队 {{queued}}，运行中 {{running}}，成功 {{succeeded}}，失败 {{failed}}", workbenchExecuted: "已在工作台执行", workbenchConfigRead: "已读取工作台配置", canvasRead: "已读取当前画布内容", selectionRead: "已读取当前选中内容", textNodes: "{{count}} 个文本", imageNodes: "{{count}} 张图片", configNodes: "{{count}} 个配置", videoNodes: "{{count}} 个视频", audioNodes: "{{count}} 个音频", groupNodes: "{{count}} 个分组", otherNodes: "{{count}} 个其他节点", connections: "{{count}} 条连线", emptyCanvas: "当前画布为空", executeTool: "执行{{tool}}", thinking: "正在思考...", operationRunning: "{{operation}}正在进行...", organizingCanvas: "画布已读取，Agent 正在整理结果...", operationCompleted: "{{operation}}已完成，Agent 正在继续处理...", attachmentPrompt: "请处理上传的图片附件。", routes: { home: "首页", canvas: "画布页面", canvasProject: "指定画布", image: "生图工作台", video: "视频工作台", prompts: "提示词中心", assets: "我的素材", config: "配置页面" } },
        runtime: {
            mcpStarting: "正在启动工具：{{name}}", mcpConnecting: "正在建立工具连接并读取可用工具列表", mcpReadyNamed: "工具已就绪：{{name}}", toolsReady: "工具列表加载完成，可以开始对话", mcpFailedNamed: "工具启动失败：{{name}}", mcpCanceledNamed: "MCP 启动已取消：{{name}}", toolInitFailed: "工具服务未能完成初始化", mcpServicesStarting: "正在启动 MCP 服务", toolServicesPending: "还有 {{count}} 个工具服务正在初始化", checkingToolServices: "正在确认工具服务状态", conversationInitializing: "正在初始化 Codex 对话", conversationCreating: "正在创建会话并启动画布工具服务", someMcpFailed: "部分 MCP 服务初始化失败", remainingToolsReady: "其余工具已就绪，可以开始对话", conversationInitFailed: "Codex 对话初始化失败", conversationCreateFailed: "无法创建 Codex 会话", mcpServicesReady: "{{count}} 个 MCP 服务已完成初始化", toolInitCanceled: "工具服务初始化已取消", mcpStatusComplete: "MCP 状态确认完成", mcpListRead: "已读取 Codex 返回的完整工具服务清单",
            historyReadFailed: "读取历史失败", conversationSyncFailed: "同步会话失败", agentOutdated: "服务版本过旧，请联系管理员", restartRequired: "需要重启 Agent", versionMismatch: "Agent 版本不匹配", awaitingApproval: "等待权限确认", codexRunning: "Codex 正在运行", connected: "已连接", localAgentConnected: "本地 Agent 已连接", processingFailed: "处理失败", completed: "完成", approvalGranted: "已批准权限", approvalCanceled: "已取消权限", log: "日志", connectionLostDescription: "连接已断开，请稍后重试", connectionFailedDescription: "连接失败，请稍后重试", connectionLost: "连接断开", connectionFailed: "连接失败", modelListFailed: "读取模型列表失败",
    ...
    simpleChat: {
        ...
        autoScroll: "自动跟随新消息",
        clearAfterSend: "发送后清空输入框",
        enterToSendHint: "Enter 发送 · Shift+Enter 换行",
        ctrlEnterToSendHint: "Ctrl/Cmd+Enter 发送 · Enter 换行",
        settingsSavedHint: "设置自动保存在本浏览器",
        heroTitle: "有什么可以帮你？",
        heroSubtitle: "输入你的问题，开始对话",
        thinking: "思考中...",
        retry: "重试",
        sendFailed: "网络连接中断，请检查网络后重试",
        sendFailedToast: "网络连接失败，请稍后重试",
        aborted: "已停止生成",
        speak: "朗读",
        stopSpeak: "停止朗读",
        regenerate: "重新生成",
        ...
        copied: "已复制",
        copyFailed: "复制失败",
        tokensTooltip: "输入 {{in}} · 输出 {{out}}",
        webSearch: "联网",
        inputPlaceholder: "输入你的问题...",
        stop: "停止",
        send: "发送",
        deleteTitle: "删除对话",
        deleteConfirm: "确定删除这个对话吗？此操作不可恢复。",
        delete: "删除",
        cancel: "取消",
        deleted: "已删除",
        deleteFailed: "删除失败",

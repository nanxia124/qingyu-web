import type { AiTextMessage } from "@canvas/services/api/image";
...
import { getGenerationResourceNodes, getGroupResourceNodes } from "@canvas/lib/canvas/canvas-resource-references";

export default {
    ...
    pages: {
        ...
        account: {
            ...
            security: { curPwdRequired: "请输入当前密码", newPwdMin: "新密码至少 8 位", mismatch: "两次输入的密码不一致", changed: "密码修改成功", changeFailed: "修改失败，请稍后重试", title: "安全设置", curPwd: "当前密码", curPwdPh: "请输入当前密码", newPwd: "新密码", newPwdPh: "至少 8 位", confirmPwd: "确认新密码", confirmPwdPh: "再次输入新密码", changing: "修改中...", change: "修改密码", pwdNeedLetterAndDigit: "密码必须同时包含字母和数字", pwMatch: "两次输入一致" },
        },
        team: {

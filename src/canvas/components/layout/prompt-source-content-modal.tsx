...
import { fetchSourcePrompts, refreshSource, type Prompt } from "@canvas/services/api/prompts";
                ...
                title={
                    <div className="flex flex-wrap items-center justify-between gap-2 pr-6">
                        <div>
                            ...
                            <div className="mt-0.5 text-xs font-normal text-zinc-500">{t("config.promptSources.content.count", { count: items.length })}</div>
                        </div>
                    ...
                    columns={[
                        {
                            ...
                            dataIndex: "coverUrl",
                            width: 72,
                            render: (coverUrl: string) => (coverUrl ? <img src={coverUrl} alt="" className="size-12 rounded object-cover" /> : <div className="size-12 rounded bg-zinc-100 dark:bg-zinc-800" />),
                        },
                        {
                            ...
                            render: (title: string, item) => (
                                <div className="min-w-0">
                                    ...
                                    <div className="mt-0.5 line-clamp-2 text-xs text-zinc-500">{item.prompt}</div>
                                </div>
                            ),
                        },
                        {

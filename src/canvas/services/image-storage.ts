...
export function collectImageStorageKeys(value: unknown, keys = new Set<string>()) {
    ...
    if ("storageKey" in value && typeof value.storageKey === "string" && (value.storageKey.startsWith("image:") || value.storageKey.startsWith("generation:"))) keys.add(value.storageKey);

...
const override={
    simpleChat: {
        ...
        newConversationFallback: "Neue Unterhaltung",
        exportChat: "Unterhaltung exportieren",
        chatSettings: "Chat-Einstellungen",
        enterToSend: "Enter zum Senden",
        autoScroll: "Automatisch zu neuen Nachrichten scrollen",
        clearAfterSend: "Eingabe nach dem Senden löschen",
        enterToSendHint: "Enter zum Senden · Umschalt+Enter für Zeilenumbruch",
        ctrlEnterToSendHint: "Strg/Cmd+Enter zum Senden · Enter für Zeilenumbruch",
        settingsSavedHint: "Einstellungen werden in diesem Browser gespeichert",
        heroTitle: "Wie kann ich dir helfen?",
        heroSubtitle: "Gib deine Frage ein, um das Gespräch zu beginnen",
        thinking: "Denkt nach...",
        retry: "Erneut versuchen",
        sendFailed: "Verbindung unterbrochen. Bitte prüfe dein Netzwerk und versuche es erneut.",
        sendFailedToast: "Netzwerkfehler, bitte später erneut versuchen",
        ...
        tokensTooltip: "Eingabe {{in}} · Ausgabe {{out}}",
        webSearch: "Websuche",
        inputPlaceholder: "Frage eingeben...",
        stop: "Stopp",
        send: "Senden",
        deleteTitle: "Unterhaltung löschen",
        deleteConfirm: "Möchtest du diese Unterhaltung wirklich löschen? Dies kann nicht rückgängig gemacht werden.",
        delete: "Löschen",
        cancel: "Abbrechen",
        deleted: "Gelöscht",
        deleteFailed: "Löschen fehlgeschlagen",
        createFailed: "Unterhaltung konnte nicht erstellt werden",
        exportEmpty: "Noch kein Inhalt zum Exportieren",
        exported: "Exportiert",
        ttsUnsupported: "Sprachsynthese wird von diesem Browser nicht unterstützt",
        today: "Heute",
        yesterday: "Gestern",
        roleDefault: "Standard",
        roleCoder: "Code-Assistent",
        roleWriter: "Schreibpartner",
        roleTranslator: "Übersetzer",
        roleInterviewer: "Simuliertes Vorstellungsgespräch",
        markdownMe: "Ich",
        markdownAI: "KI",
        defaultTitle: "Unterhaltung",
    },
    ...
    videoWorkbench: {
      ...
      statusSaving: "Ergebnis wird gespeichert…",
    ...
    canvas: {
      editors: {
              reset: "Zurücksetzen",
              cancel: "Abbrechen",
              confirmCrop: "Zuschneiden",
              cropTitle: "Bild zuschneiden",
              maskTitle: "Lokale Bearbeitung",
              maskGenerate: "Jetzt generieren",
              splitTitle: "Bild teilen",
              upscaleTitle: "Bild hochskalieren",
              rows: "Zeilen",
              columns: "Spalten",
              brush: "Pinsel",
              erase: "Radierer",

    ...
    return (
        <div className="mb-2">
            ...
            <div className="thin-scrollbar flex min-h-12 gap-2 overflow-x-auto pb-1">
                ...
                <button type="button" className="grid size-12 shrink-0 place-items-center rounded-md border bg-transparent transition hover:opacity-70" style={{ borderColor: theme.toolbar.border, color: theme.node.muted }} onClick={() => onStartSelection?.(nodeId)}>

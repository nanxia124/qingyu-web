...
export function CanvasPromptChipInput({ value, references, onChange, onSubmit, onPasteImage, className, style, placeholder }: Props) {
    ...
    const handlePaste = (e: React.ClipboardEvent<HTMLDivElement>) => {
        console.log('paste event triggered in chip input');
        ...
        for (const item of Array.from(items)) {
            if (item.type.startsWith("image/")) {
                e.preventDefault();
                console.log('image found, calling onPasteImage');

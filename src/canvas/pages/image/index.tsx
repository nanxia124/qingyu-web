    ...
    return (
        <div className="flex h-full flex-col overflow-hidden bg-zinc-50 text-zinc-900 dark:bg-zinc-950 dark:text-zinc-100">
            <main className="grid min-h-0 flex-1 grid-cols-1 gap-3 overflow-y-auto p-3 lg:grid-cols-[300px_minmax(0,1fr)] lg:overflow-hidden xl:grid-cols-[320px_minmax(0,1fr)]">
                <aside className="thin-scrollbar hidden min-h-0 overflow-y-auto rounded-lg border border-zinc-200 bg-card p-4 dark:border-zinc-800 lg:block">
                    <LogPanel
                        logs={logs}
                ...
                <section className="grid gap-3 lg:min-h-0 lg:overflow-hidden xl:grid-cols-[420px_minmax(0,1fr)]">
                    <div className="thin-scrollbar flex flex-col rounded-lg border border-zinc-200 bg-card p-4 dark:border-zinc-800 lg:min-h-0 lg:overflow-y-auto">
                        <div>
                    ...
                    <div className="thin-scrollbar rounded-lg border border-zinc-200 bg-card p-4 dark:border-zinc-800 lg:min-h-0 lg:overflow-y-auto lg:p-5">

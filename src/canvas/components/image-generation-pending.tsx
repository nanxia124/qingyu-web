...
import { formatDuration } from "@canvas/lib/image-utils";
...
export function ImageGenerationPending({ className, label, compact = false }: { className?: string; label?: string; compact?: boolean }) {
    ...
    return (
        <div className={cn("relative overflow-hidden bg-zinc-100 dark:bg-white/10", compact ? "min-h-24" : "aspect-[4/3]", className)}>
            <div
            ...
            />
            <div className="absolute left-4 top-4 flex items-center gap-2 text-[15px] font-medium text-zinc-500 dark:text-zinc-300">
            ...
            <div className="absolute bottom-4 left-4 right-4">
                ...
                <div className="h-1.5 rounded-full bg-zinc-300/70 dark:bg-white/12">

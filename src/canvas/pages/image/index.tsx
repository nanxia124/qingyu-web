    ...
    return (
        <div className="flex h-full flex-col overflow-hidden bg-zinc-50 text-zinc-900 dark:bg-zinc-950 dark:text-zinc-100">
            <main className="grid min-h-0 flex-1 grid-cols-1 gap-3 overflow-y-auto p-3 lg:grid-cols-[300px_minmax(0,1fr)] lg:overflow-hidden xl:grid-cols-[320px_minmax(0,1fr)]">
                <aside className="thin-scrollbar hidden min-h-0 overflow-y-auto rounded-lg border border-zinc-200 bg-card p-4 shadow-sm dark:border-zinc-800 lg:block">
                    <LogPanel
                        logs={logs}
                ...
                <section className="grid gap-3 lg:min-h-0 lg:overflow-hidden xl:grid-cols-[420px_minmax(0,1fr)]">
                    <div className="thin-scrollbar flex flex-col rounded-lg border border-zinc-200 bg-card p-4 shadow-sm dark:border-zinc-800 lg:min-h-0 lg:overflow-y-auto">
                        <div>
                            <div className="flex items-start justify-between gap-3">
                                <div className="min-w-0">
                                    <h1 className="text-2xl font-semibold text-zinc-950 dark:text-zinc-100">{t("imageWorkbench.title")}</h1>
                                </div>
                        ...
                        <div className="mt-6 space-y-5">
                            ...
                            <div className="min-w-0">
                                ...
                                <div
                                    className={`hover-scrollbar hover-scrollbar-hint relative flex min-h-24 w-full min-w-0 max-w-full gap-2 overflow-x-scroll overflow-y-hidden rounded-lg border border-dashed p-2 pb-3 overscroll-x-contain transition-colors ${isReferenceDragActive ? "border-zinc-900 bg-zinc-100/80 dark:border-zinc-100 dark:bg-zinc-900/80" : "border-zinc-300 dark:border-zinc-700"}`}
                                    onDragEnter={(event) => {
                                ...
                                >
                                    {references.map((item, index) => (
                                        <div key={item.id} className="group relative size-20 shrink-0 overflow-hidden rounded-md border border-zinc-200 dark:border-zinc-800">
                                    ...
                                    {!references.length ? <div className="flex min-w-full items-center justify-center text-sm text-zinc-500">{isReferenceDragActive ? t("imageWorkbench.dropReferences") : t("imageWorkbench.noReferences")}</div> : null}
                                </div>
                            </div>

                            <div className="flex items-center justify-between rounded-lg border border-zinc-200 bg-zinc-50 px-3 py-2 text-sm dark:border-zinc-800 dark:bg-zinc-900 sm:hidden">
                    ...
                    <div className="thin-scrollbar rounded-lg border border-zinc-200 bg-card p-4 shadow-sm dark:border-zinc-800 lg:min-h-0 lg:overflow-y-auto lg:p-5">
                        ...
                        {results.length ? (
                            ...
                            <div className="flex min-h-[320px] flex-col items-center justify-center rounded-lg border border-dashed border-zinc-300 text-center dark:border-zinc-700 lg:min-h-[560px]">
                                <ImagePlus className="mb-4 size-11 text-zinc-400" />
...
function ResultImageCard({
    ...
    useSyncExternalStore(subscribeImagePreviews, getImagePreviewRevision);
    return (
        <div className="overflow-hidden rounded-lg border border-zinc-200 bg-background dark:border-zinc-800">
            ...
            <div className="space-y-2 border-t border-zinc-200 px-3 py-2.5 dark:border-zinc-800">
                <div className="flex min-w-0 gap-x-2 gap-y-1 text-xs text-zinc-500 dark:text-zinc-400">
                    <span>
...
function PendingImageCard() {
    const { t } = useTranslation();
    return (
        <div className="relative aspect-square overflow-hidden rounded-lg border border-dashed border-zinc-300 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            <div
            ...
            />
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 text-sm text-zinc-500 dark:text-zinc-400">
    ...
    return (
        <>
            ...
            <div className="space-y-3">
                ...
                {!logs.length ? <div className="flex min-h-48 items-center justify-center rounded-lg border border-dashed border-zinc-300 text-center text-sm text-zinc-500 dark:border-zinc-700">{t("workbench.noLogs")}</div> : null}
            </div>
        </>
    );
}
...
function LogCard({ log, selected, active, onSelectedChange, onClick }: { log: GenerationLog; selected: boolean; active: boolean; onSelectedChange: (checked: boolean) => void; onClick: () => void }) {
    ...
    return (
        <button
            type="button"
            className={`block w-full rounded-lg border p-2 text-left transition ${active ? "border-zinc-900 bg-blue-50 dark:border-zinc-100 dark:bg-blue-950/20" : "border-zinc-200 bg-background hover:bg-zinc-50 dark:border-zinc-800 dark:hover:bg-zinc-900"}`}
            onClick={onClick}
        >

...
export function AppTopNav() {
    ...
    return (
        <>
            {!hideHeader ? (
                <header className="sticky top-0 z-20 h-14 shrink-0 border-b border-zinc-200 bg-background/90 backdrop-blur-xl dark:border-zinc-800">
                    <div className="mx-auto flex h-full max-w-7xl items-stretch justify-between gap-5 px-6">
                        <div className="flex min-w-0 items-center">
                            <Link to="/" className="flex h-full shrink-0 items-center gap-2 text-sm font-semibold leading-none tracking-tight text-zinc-950 transition hover:text-zinc-600 dark:text-zinc-100 dark:hover:text-zinc-300">
                                <span
                            ...
                            <button
                                type="button"
                                className="ml-3 inline-flex size-8 shrink-0 items-center justify-center text-zinc-600 transition hover:text-zinc-950 md:hidden dark:text-zinc-300 dark:hover:text-white"
                                    ...
                                    return (
                                        <Link
                                            ...
                                            className={cn(
                                                ...
                                                active
                                                    ? "font-medium text-zinc-950 after:bg-zinc-950 dark:text-zinc-100 dark:after:bg-zinc-100"
                                                    : "text-zinc-500 after:bg-transparent hover:text-zinc-950 dark:text-zinc-400 dark:hover:text-zinc-100",
                                            )}
                                        >

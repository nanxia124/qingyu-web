        ...
        <main className="h-full overflow-auto bg-background text-zinc-950 dark:text-zinc-100">
            <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-6 py-10">
                <header className="flex flex-wrap items-end justify-between gap-4 border-b border-zinc-200 pb-6 dark:border-zinc-800">
                    <div>
                        <p className="text-xs text-zinc-500">{t("canvas.library")}</p>
                ...
                {!hydrated ? (
                    <section className="flex min-h-[360px] items-center justify-center border-y border-zinc-200 text-sm text-zinc-500 dark:border-zinc-800">{t("canvas.loading")}</section>
                ) : projects.length ? (
                    ...
                    <section className="flex min-h-[360px] flex-col items-center justify-center border-y border-zinc-200 text-center dark:border-zinc-800">
                        <h2 className="text-xl font-medium">{t("canvas.empty")}</h2>
                        <p className="mt-3 text-sm text-zinc-500">{t("canvas.emptyDescription")}</p>

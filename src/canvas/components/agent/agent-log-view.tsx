...
import type { AgentEventLog } from "@canvas/stores/use-agent-store";
            ...
            <div className="flex h-full min-h-0 flex-col gap-3">
                ...
                <div className="border-y py-2.5" style={{ borderColor: theme.node.stroke }}>
                    <div className="flex items-start gap-2.5">
                        <span className={`mt-1.5 size-2 shrink-0 rounded-full ${context.connected ? "bg-emerald-500" : context.enabled ? "bg-amber-400" : "bg-current opacity-30"}`} />

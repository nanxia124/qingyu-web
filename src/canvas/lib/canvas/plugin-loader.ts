import { registerNodeDefinitions, unregisterPluginNodes } from "@canvas/lib/canvas/node-registry";
import { getPluginRuntime } from "@canvas/lib/canvas/plugin-runtime";

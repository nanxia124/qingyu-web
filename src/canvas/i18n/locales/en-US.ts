export default {
    ...
    pages: {
        ...
        plan: { market: "Market analysis", vision: "Visual strategy", compliance: "Compliance review", export: "Export", title: "AI full-plan planner", subtitle: "Enter product info and auto-run market analysis → visual strategy → compliance review → export", productPh: "Product / brand name, e.g. LITZONE AI subscription", bgPh: "Target users, channels, budget (optional)", running: "Generating plan…", start: "Generate plan" },
        admin: {

export default {
    ...
    takeover: {
        newTitle: "Another device is already signed in",
        newDesc: "Another device is using this account: {{device}}. If you switch here, that device will be signed out.",
        takeOver: "Switch to this device",
        cancel: "Cancel",
        waiting: "Waiting for confirmation…",
        denied: "The sign-in request was rejected on another device",
        expired: "Sign-in confirmation timed out, please sign in again",
        oldTitle: "New device sign-in detected",
        oldDesc: "A new device ({{device}}) is requesting to sign in to this account.",
        leakWarn: "If this was not you, your password may have been compromised. Change it now.",
        allow: "Allow and sign out this device",
        deny: "Deny",
    ...
    pages: {
        ...
        account: {
            ...
            security: { curPwdRequired: "Enter current password", newPwdMin: "New password must be at least 8 chars", mismatch: "Passwords do not match", changed: "Password changed", changeFailed: "Change failed, please retry", title: "Security", curPwd: "Current password", curPwdPh: "Enter current password", newPwd: "New password", newPwdPh: "At least 8 chars", confirmPwd: "Confirm new password", confirmPwdPh: "Re-enter new password", changing: "Changing...", change: "Change password", pwdNeedLetterAndDigit: "Password must contain both letters and numbers", pwMatch: "Passwords match" },
        },
        team: {
        ...
        authPage: { fillBoth: "Enter email and password", emailInvalid: "Invalid email format", pwdMin: "Password must be at least 8 chars", fillNick: "Enter your nickname", opFailed: "Operation failed, please retry", login: "Sign in", register: "Sign up", nickname: "Nickname", email: "Email", password: "Password (min 8 chars)", loading: "Loading...", noAccount: "Don't have an account?", hasAccount: "Already have an account?" },
        resetPwd: { invalid: "Invalid reset link, please request a new one", invalidOnly: "Invalid reset link", pwdMin: "Password must be at least 8 chars", mismatch: "Passwords do not match", success: "Password reset, redirecting to sign in...", failed: "Reset failed", failedRetry: "Reset failed, please retry", title: "Reset password", subtitle: "Set a new password", newPwdPh: "New password (min 8 chars)", confirmPh: "Confirm new password", submitting: "Submitting...", confirm: "Confirm reset", backHome: "Back home", pwdNeedLetterAndDigit: "Password must contain both letters and numbers", pwMatch: "Passwords match" },
        ...
        admin: {
            ...
            signupGift: { tab: "Signup bonus", title: "New user signup bonus", description: "Changes apply only to users who sign up after saving. Credits already granted will not change. Set to 0 to pause signup bonuses.", amount: "Bonus amount", unit: "credits", save: "Save", saving: "Saving…", saved: "Signup bonus setting saved", invalid: "Enter a valid number greater than or equal to 0", saveFailed: "Could not save signup bonus setting" },

    ...
    return (
        ...
        >
            <div className="space-y-5">
                ...
                <div className="flex items-center justify-between border-y border-zinc-200 py-3 dark:border-zinc-800">
                ...
                <div>
                    ...
                    <pre className="overflow-x-auto rounded-md bg-zinc-100 p-3 text-xs leading-5 text-zinc-600 dark:bg-zinc-900 dark:text-zinc-300">{`[
  {
    "id": "product-photo-1",
    "title": "Product photo",
